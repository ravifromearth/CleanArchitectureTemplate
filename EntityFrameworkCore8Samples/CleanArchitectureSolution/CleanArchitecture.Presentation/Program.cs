...
using EntityFrameworkCore8Samples.Application.Configuration;
...
using EntityFrameworkCore8Samples.Infrastructure.Repositories;
...
Console.WriteLine("1. 🖥️  Interactive Mode    - Full menu-driven interface with CRUD operations");
...
try
{
    ...
    switch (modeChoice)
    {
        case "1":
            // Interactive Mode
            var interactiveApp = new EntityFrameworkCore8Samples.InteractiveConsoleApp(services);
